            ...
            <div className="w-full max-w-md bg-[#161616] border border-neutral-800 rounded-xl pt-8 pb-6 px-6 shadow-2xl">
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2">
                            <span className="text-lime-500 mr-3 text-sm">🆔</span>
                            <input type="text" placeholder="xxxxxxxxxxxx" className="bg-transparent w-full text-xs text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2">
                            <span className="text-lime-500 mr-3 text-sm">📱</span>
                            <input type="text" placeholder="07XXXXXXXX" className="bg-transparent w-full text-xs text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>
