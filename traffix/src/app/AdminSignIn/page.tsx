        ...
        <div className="min-h-screen bg-[#111111] text-neutral-200 font-sans flex flex-col items-center justify-center p-6 relative">
            <div className="w-full max-w-md bg-[#161616] border border-neutral-800 rounded-xl pt-8 pb-6 px-6 shadow-2xl">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-xs text-white mb-1.5 font-medium">Full Name</label>
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2.5">
                            ...
                            <input type="text" placeholder="Enter your full name" className="bg-transparent w-full text-sm text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2.5">
                            ...
                            <input type="email" placeholder="username@gmail.com" className="bg-transparent w-full text-sm text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2.5">
                            <span className="text-lime-500 mr-3">🔒</span>
                            <input type="password" placeholder="••••••••" className="bg-transparent w-full text-sm text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center bg-black border border-neutral-800 rounded px-3 py-2.5">
                            <span className="text-lime-500 mr-3">🔑</span>
                            <input type="password" placeholder="Institutional Access Key" className="bg-transparent w-full text-sm text-white focus:outline-none placeholder-neutral-600" />
                        </div>
                    </div>

                    <button className="w-full bg-lime-400 hover:bg-lime-500 text-black font-bold py-3 mt-4 rounded text-sm transition-colors flex items-center justify-center gap-2 tracking-wide">
                        AUTHENTICATE SYSTEM
                    </button>
                </div>
